...
IF ~~ THEN BEGIN JNRM4
	SAY @1 /* I can certainly try, but our church will require a donation for such a service. */
	+ ~PartyGoldGT(2000)~ + @2 GOTO JNRM4.1 /* Fine. Here you have two thousand gold. Get to work. */
	+ ~PartyGoldGT(1000)~ + @3 GOTO JNRM4.2 /* Would a thousand gold suffice? */
...
IF ~~ THEN BEGIN JNRM4.1
	SAY @7 /* Certainly. */
	
	IF ~~ THEN DO ~TakePartyGold(2000)~ GOTO JNRM4.res
END

IF ~~ THEN BEGIN JNRM4.2
	SAY @6 /* If that is all you can offer it will do. */
	
	IF ~~ THEN DO ~TakePartyGold(1000)~ GOTO JNRM4.res
END

IF ~~ THEN BEGIN JNRM4.3
	SAY @9 /* You will not find such a service here! What you suggest is foul I will have no more of it. */
	+ ~ReputationGT(Player1,14)~ + @10 GOTO JNRM4.3.1 /* Haven't you heard of me? I am a force of good and you can trust in my judgement. */
	+ ~ReputationLT(Player1,13)~ + @10 GOTO JNRM4.3.2 /* Haven't you heard of me? I am a force of good and you can trust in my judgement. */
	++ @11 GOTO JNRM4.3.2 /* What's the problem? I don't see any harm in it. */
	++ @12 DO ~TakePartyGold(2000)~ GOTO JNRM4.res /* I'm sorry I don't know why I said that. Two thousand gold you said? Here you go. */
	++ @5 EXIT /* Actually nevermind. */
END
...
IF ~~ THEN BEGIN JNRM5.3
	SAY @9 /* You will not find such a service here! What you suggest is foul I will have no more of it. */
	+ ~ReputationGT(Player1,14)~ + @10 GOTO JNRM5.3.1 /* Haven't you heard of me? I am a force of good and you can trust in my judgement. */
	+ ~ReputationLT(Player1,13)~ + @10 GOTO JNRM5.3.2 /* Haven't you heard of me? I am a force of good and you can trust in my judgement. */
